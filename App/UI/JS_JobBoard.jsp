                  ...
                  <div class="menu_div">
                      <div class="menu">
                          <ul class="nav nav-tabs" role="tablist">
                              <li role="presentation"><a href="JS_AccOverview.jsp">Account Overview</a></li>
                              <li role="presentation"><a href="JS_JobBoard.jsp" class="active">Job Board</a></li>
      ...
      <div class="m_about">
          <div>
              <div class="text-center">
                  <h2>Match your skills, find mroe jobs!</h2>
                  <div class="search_f">
